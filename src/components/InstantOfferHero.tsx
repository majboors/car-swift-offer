        ...
        <div className="max-w-xl">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <ul className="flex border-b border-gray-200 mb-6">
              <li className="mr-1">
                <button 
                  className="bg-white inline-block py-2 px-4 text-[#007ac8] font-semibold border-b-2 border-[#007ac8]"
                >
              ...
              <li className="mr-1">
                <button 
                  className="bg-white inline-block py-2 px-4 text-gray-500 font-semibold hover:text-gray-800"
            ...
            {/* Car Search Form (Simplified) */}
            <form onSubmit={handleCarSearch} className="hidden mb-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Make
